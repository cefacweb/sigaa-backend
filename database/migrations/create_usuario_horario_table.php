...
class CreateUsuarioHorarioTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('usuario_horario', function (Blueprint $table) {
            ...
            $table->unique(['COD_USUARIO', 'NUM_DIA_SEMANA', 'HOR_INICIO'], 'IDXUSUARIO_HORARIO_COD_USUARIO_NUM_DIA_SEMANA_HOR_INICIO');
            $table->primary(['COD_USUARIO', 'NUM_DIA_SEMANA', 'HOR_INICIO']);
        });
    }
