...
class CreateRanchoAlimentoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rancho_alimento', function (Blueprint $table) {
            ...
            $table->unique(['COD_PESSOA', 'DAT_PREVISTA', 'COD_ALIMENTO'], 'IDXRANCHO_ALIMENTO_COD_PESSOA_DAT_PREVISTA_COD_ALIMENTO');
            $table->primary(['COD_PESSOA', 'DAT_PREVISTA', 'COD_ALIMENTO']);
        });
    }
