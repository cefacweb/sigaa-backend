...
class CreateEnxovalTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('enxoval', function (Blueprint $table) {
            ...
            $table->unique(['COD_PESSOA', 'DAT_REGISTRO_GESTACAO', 'DAT_AGENDA'], 'IDXENXOVAL_COD_PESSOA_DAT_REGISTRO_GESTACAO_DAT_AGENDA');
            $table->primary(['COD_PESSOA', 'DAT_REGISTRO_GESTACAO', 'DAT_AGENDA']);
        });
    }
